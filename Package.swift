...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            checksum: "10fc34de52e4f6ad8d84f0f5d754469b42731d39f9ba16aadd50d6522a74f627"
        ),
        .binaryTarget(
            name: "TXFFmpeg",
            url: "https://liteav.sdk.qcloud.com/download/spm/12.4/trtc/TXFFmpeg.xcframework.zip",
            checksum: "26ef40c4a981b6fcc469aca5217851b9704751207db48c30fb92ac5ab56a36b9"
        ),
        .binaryTarget(
            name: "TXLiteAVSDK_ReplayKitExt",
            url: "https://liteav.sdk.qcloud.com/download/spm/12.4/professional/TXLiteAVSDK_ReplayKitExt.xcframework.zip",
            checksum: "932dd79345193035743abc637036b4136669b487af423959bbf6e6309359e1c4"
        ),
        .binaryTarget(
            name: "TXSoundTouch",
            url: "https://liteav.sdk.qcloud.com/download/spm/12.4/trtc/TXSoundTouch.xcframework.zip",
            checksum: "417486e38fc97bdf8994660156637b5c92060e0432122d4658bc01c74159df32"
        ),.target(
            name: "TRTC_SwiftPM",
            dependencies: [
